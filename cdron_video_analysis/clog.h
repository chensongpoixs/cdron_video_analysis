...
#define CFUNCTION __PRETTY_FUNCTION__
...
#pragma error "unknow platform!!!"
	...
	//ï¿½ï¿½×¼log ï¿½ï¿½Ê±ï¿½ï¿½Ç°×º
#define LOG_SYSTEM CLOG(ELogLevel_System)
#define LOG_FATAL  CLOG(ELogLevel_Fatal, CFUNCTION, __LINE__)
#define LOG_ERROR  CLOG(ELogLevel_Error, CFUNCTION, __LINE__)
#define LOG_WARN   CLOG(ELogLevel_Warn, CFUNCTION, __LINE__)
#define LOG_INFO   CLOG(ELogLevel_Info)
#define LOG_DEBUG  CLOG(ELogLevel_Debug)

#define FIX_LOG CLOG::fix_log
#define VAR_LOG CLOG::var_log
...
#define NORMAL_EX_LOG(format, ...)	NORMAL_LOG  ("[%s][%d]" format, CFUNCTION, __LINE__, ##__VA_ARGS__)
#define ERROR_EX_LOG(format, ...)	ERROR_LOG  ("[%s][%d]" format, CFUNCTION, __LINE__, ##__VA_ARGS__)
#define WARNING_EX_LOG(format, ...)	WARNING_LOG("[%s][%d]" format, CFUNCTION, __LINE__, ##__VA_ARGS__)
#define DEBUG_EX_LOG(format, ...)	DEBUG_LOG("[%s][%d]" format, CFUNCTION, __LINE__, ##__VA_ARGS__)
////////////////
