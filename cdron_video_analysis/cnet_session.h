...
namespace chen {
	...
	public:
		...
		bool	process_msg();
		/**
		* ·¢ËÍÊý¾Ý°ü»º´æµ½·¢ËÍ»º³åÇøÖÐ
		* @param   msg_ptr	: ·¢ËÍÊý¾Ý°ü
		* @param   size		: ·¢ËÍÊý¾Ý°üµÄ´óÐ¡
		**/
	...
	private:
		...
		uint32					m_session_id;		// ÍøÂç²ãµÄ»á»°id
		...
		cnet_msg*				m_recv_ptr;
		uint32					m_recv_size;			//½ÓÊÕ»º³åÇø´óÐ¡
		// send 
		...
		uint32					m_send_size;         //·¢ËÍ»º³åÇøµÄ´óÐ¡
		//char					m_buf[1024];
